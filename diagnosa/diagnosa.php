...
<html lang="en">
  <head>
    ...
    <!-- Website Title -->
    <title>Diagnosa | Sistem Pakar Diagnosa</title>
    <!-- Favicon Website -->
      ...
      if (isset ($_GET['message'])) {
        ...
        if ($message == 'failed') {
          ...
          <script language="Javascript">
            swal({
              title: 'Gagal Diagnosa',
              text: 'Tidak dapat mendiagnosa penyakit dengan gejala tersebut, cek kembali Basis Informasi',
              type: 'error',
    ...
    <main>
        ...
        <div class="data bg-white p-3">
            <div class="alert alert-info fade show">
                <span class="iconify icon me-2 d-block mb-2" data-icon="healthicons:symptom" data-width="45"></span>
