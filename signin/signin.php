...
<html lang="en">
  <head>
    ...
    <!-- Website Title -->
    <title>Masuk | Sistem Pakar Diagnosa</title>
    <!-- Favicon Website -->
      ...
      if (isset ($_GET['message'])) {
        ...
        if ($message == 'failed') {
          ...
          <script language="Javascript">
              swal({
                title: 'Gagal Masuk',
                text: 'username atau password salah, Cek kembali username atau password anda',
                type: 'error',
          ...
          <div class="align-items-center justify-content-center d-lg-none d-flex">
            <img class="img-fluid" src="http://api.elements.buildwithangga.com/storage/files/2/assets/Empty%20State/EmptyState3/Empty-3-5.png" alt="vector image login" />
              ...
              <form action="../assets/database/config_signin.php" method="post">
                ...
                <p>Belum Punya Akun? <a href="../signup/signup.php" style="color: #524EEE">Daftar</a></p>
              </form>
