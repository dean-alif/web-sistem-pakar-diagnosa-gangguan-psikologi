...
<html lang="en">
  <head>
    ...
    <!-- Website Title -->
    <title>Aturan | Sistem Pakar Diagnosa</title>
    <!-- Favicon Website -->
      ...
      <main>
        <div class="container ps-4 pe-4 pt-2 pb-2">
          ...
          <nav class="navbar navbar-light">
            ...
            <div class="navbar-text fw-bold fs-5">Aturan</div>
            ...
            <table class="table table-responsive table-striped">
              <thead>
                <tr>
                  ...
                  <th>Kode</th>
                  <th>Jika</th>
                  <th style="border-radius: 0 0.5em 0 0">Maka</th>
                </tr>
              </thead>
              <tbody>
                <?php
                  $query = mysqli_query ($connect, "SELECT * FROM aturan") or die (mysqli_error ($connect));
                  $no = 1;
                ...
                <tr>
                  ...
                  <th class="text-capitalize"><?php echo $aturan['jika']; ?></th>
                  <th class="text-capitalize"><?php echo $aturan['maka']; ?></th>
                </tr>
                <?php } ?>
              </tbody>
            </table>
