...
<html lang="en">
  <head>
    ...
    <!-- Website Title -->
    <title>Dashboard Admin | Sistem Pakar Diagnosa</title>
    <!-- Favicon Website -->
      ...
      <div class="container p-3">
        <div class="row">
          <div class="col-sm-8">
            <div class="row d-flex justify-content-around align-items-center">
              <div class="col-3">
                <div class="card p-2 text-center">
                  <a href="#penyakit">
                    <span class="iconify icon mx-auto" data-icon="ic:baseline-psychology-alt" data-width="45"></span>
              ...
              <div class="col-3">
                <div class="card p-2 text-center">
                  <a href="#gejala">
                    <span class="iconify icon mx-auto" data-icon="healthicons:symptom" data-width="45"></span>
              ...
              <div class="col-3">
                <div class="card p-2 text-center">
                  <a href="#pengetahuan">
                    <span class="iconify icon mx-auto" data-icon="ion:information-circle-outline" data-width="45"></span>
                    <p class="text-white">Basis Informasi</p>
                  </a>
                </div>
              </div>
              <div class="col-3">
                <div class="card p-2 text-center">
                  <a href="#aturan">
                    <span class="iconify icon mx-auto" data-icon="carbon:rule-data-quality" data-width="45"></span>
            ...
            <div class="data bg-white p-3">
              ...
              <table class="table table-responsive table-bordered">
                <tbody>
                  ...
                  ?>
                  <tr style="background-color: #78A6C8; color: #fff">
                    <td>Penyakit</td>
                    <td>:</td>
            ...
            <h5 class="fw-bold mt-4" id="pengetahuan">Basis Informasi</h5>
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <div class="modal-header">
              <span class="iconify icon me-4" data-icon="ic:baseline-psychology-alt" data-width="45"></span>
              <h5>Data Penyakit</h5>
      ...
      <div class="modal fade" id="addGejala" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="tambahPenyakit" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            <!-- Modal Header Start -->
            <div class="modal-header">
              <span class="iconify icon me-4" data-icon="healthicons:symptom" data-width="45"></span>
              <h5>Data Gejala</h5>
              <button type="button" class="btn-close me-2" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <!-- Modal Header end -->
      ...
      <div class="modal fade" id="addBasisPengetahuan" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="tambahPenyakit" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            <!-- Modal Header Start -->
            <div class="modal-header">
              <span class="iconify icon me-4" data-icon="ion:information-circle-outline" data-width="45"></span>
      ...
      <div class="modal fade" id="addAturan" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="tambahPenyakit" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            <!-- Modal Header Start -->
            <div class="modal-header">
              <span class="iconify icon me-4" data-icon="carbon:rule-data-quality" data-width="45"></span>
              <h5>Aturan</h5>
              <button type="button" class="btn-close me-2" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <!-- Modal Header end -->
